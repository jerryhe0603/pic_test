...
<center>
 ...
 -->
	    ...
	    <span><?php echo _('類別名稱') ?>:</span>
	    <input id="search_name" class="easyui-textbox"  search_type='like' search_column='<?php echo $SQL_tableName ?>.type_name' >
